...
> * **ML API**: Once you found a ML model that meets your project's requirements, you will likely deploy an API that will be embedded to an existing solution. The API will have an endpoint where the users will predict. The [API](https://doreto-ml-api.herokuapp.com/) was made with Django Rest Framework and deployed at Heroku. This project explains the ML Business Case behind the project, the API functionality and request data from the API. [Click here](https://share.streamlit.io/fernandorocha88/portfolio-ml-api/main/app.py)
